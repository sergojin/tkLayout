...
$(LIBDIR)/TrackFinder.o: $(SRCDIR)/TrackFinder.cpp $(INCDIR)/TrackFinder.h
	@echo "Building target TrackFinder.o..."	
	$(COMP) $(ROOTFLAGS) -c -o $(LIBDIR)/TrackFinder.o $(SRCDIR)/TrackFinder.cpp
	@echo "Built target TrackFinder.o"
...
$(BINDIR)/tklayout: $(LIBDIR)/tklayout.o $(LIBDIR)/CoordinateOperations.o $(LIBDIR)/hit.o $(LIBDIR)/global_funcs.o $(LIBDIR)/Polygon3d.o \
	$(LIBDIR)/Property.o \
	$(LIBDIR)/Sensor.o $(LIBDIR)/GeometricModule.o $(LIBDIR)/DetectorModule.o $(LIBDIR)/RodPair.o $(LIBDIR)/Layer.o $(LIBDIR)/Barrel.o $(LIBDIR)/Ring.o $(LIBDIR)/Disk.o $(LIBDIR)/Endcap.o $(LIBDIR)/Tracker.o $(LIBDIR)/Ribbon.o $(LIBDIR)/Cable.o $(LIBDIR)/DTC.o $(LIBDIR)/TrackFinder.o $(LIBDIR)/SimParms.o \
